...
export function TotalUsersCard({ value }: { value: number }) {
  return (
    <Link href="/admin/all-users" className="block">
      <div className="relative overflow-hidden rounded-xl bg-linear-to-r from-purple-600 to-purple-800 p-4 sm:p-6 shadow-lg cursor-pointer hover:opacity-95 transition-opacity">
